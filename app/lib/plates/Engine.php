...
require("Template/Directory.php");
require("Template/Template.php");
require("Template/FileExtension.php");
require("Template/Folders.php");
require("Template/Func.php");
require("Template/Functions.php");
require("Template/Name.php");
require("Extension/ExtensionInterface.php");
